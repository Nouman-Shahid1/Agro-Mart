...
import { getProducts} from "@/reducers/product/productSlice"; // Redux action to fetch rental machines
...
export default function RentalMachines() {
  ...
  // const { rentalMachines, loading, error } = useSelector((state) => state.rental);
 useEffect(() => {
    // Fetch products when the component mounts
    dispatch(getProducts());
  }, [dispatch]);
  // useEffect(() => {
  //   dispatch(getRentalMachines());
  // }, [dispatch]);
